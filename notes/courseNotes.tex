...
\qs{Proof Practice}{
    ...
    \begin{align*}
        R &= \{x\in \bbZ{} \mid x\text{ is divisible by } 2\}\\
        S &= \{y\in \bbZ{} \mid y\text{ is divisible by } 3\}\\
        T &= \{z\in \bbZ{} \mid z\text{ is divisible by } 6\}
    \end{align*}
    ...
    \sol{
        \begin{enumerate}
            \item [(a)] \begin{myproof}
                Suppose $R\subseteq T$, then by definition of a subset, every element in $R$ must be common to $T$.
                However, $2\in R$ but $2\notin T$ as $\frac{2}{6}\notin \bbZ{}$.
                Thus $R\nsubseteq T$.
            \end{myproof}
            \item [(b)] \begin{myproof}
                Let $z\in T$ then by definition of $T$, $z=6\ell$ for some integer $\ell$.
                By basic algebra we can see that $z=2(3\ell)$, where $3\ell \in \bbZ$ as it is a product of integers.
                Thus $z=2m$ for some integer $m$.
                Hence, by definition of set $R$, $T\subseteq R$.
            \end{myproof}
            \item [(c)] \begin{myproof}
                Let $z\in T$ then by definition of $T$, $z=6\ell$ for some integer $\ell$.
                By basic algebra we can see that $z=3(2\ell)$, where $2\ell \in \bbZ$ as it is a product of integers.
                Thus $z=3m$ for some integer $m$.
                Hence, by definition of set $S$, $T\subseteq S$.
            \end{myproof}
        \end{enumerate}
    }
}
\section{Properties of Sets}
\subsection{Some Subset Relations}
\thm{Some Subset Relations}{
    \begin{enumerate}

        \item [(1)] Inclusion of Intersection: For all sets $A$ and $B$,
    \end{enumerate} \begin{enumerate} \begin{enumerate}
        \item [(a)] $A\cap B\subseteq A$ and (b) $A\cap B\subseteq B$
        \end{enumerate}

        \item [(2)] Inclusion of Union: For all sets $A$ and $B$,
    \end{enumerate} \begin{enumerate} \begin{enumerate}
            \item [(a)] $A\subseteq A\cup B$ and (b) $B\subseteq A\cup B$ 
        \end{enumerate}

        \item [(3)] Transitive Property of Subsets: For all sets $A$ and $B$ and $C$,
    \end{enumerate} \begin{enumerate} \begin{enumerate}
            \item [(a)] If $A\subseteq B$ and $B\subseteq C$, then $A\subseteq C$
        \end{enumerate}

    \end{enumerate}
}

\dfn{Procedural Versions of Set Definitions}{
    \begin{enumerate}
        \item [(1)] $x\in X\cup Y \Leftrightarrow x\in X$ or $x\in Y$
        \item [(2)] $x\in X\cap Y \Leftrightarrow x\in X$ and $x\in Y$
        \item [(3)] $x\in X-Y \Leftrightarrow x\in X$ and $x\notin Y$
        \item [(4)] $x\in X^\mathsf{c} \Leftrightarrow x\notin X$
        \item [(5)] $(x,y)\in X\times Y \Leftrightarrow x\in X$ and $y\in Y$
    \end{enumerate}
}

\subsection{Proving a Subset Relation}
\begin{myproof}[Proof of Theorem 6.2.1-1]
...
\end{myproof}
\begin{myproof}[Proof of Theorem 6.2.1-2]
...
\begin{enumerate}
    \item [(1)] Cummutative Laws: For all sets $A$ and $B$,
\end{enumerate} \begin{enumerate} \begin{itemize}
...
\end{enumerate} \begin{enumerate} \begin{itemize}
    ...
    \end{itemize} 
    \item [(4)] Identity Laws: For every set $A$,
\end{enumerate} \begin{enumerate} \begin{itemize}
        \item $A\cup \emptyset=A$
        \item $A\cap U=A$
\end{itemize}
    \item [(5)] Complement Laws: For every set $A$,
\end{enumerate} \begin{enumerate} \begin{itemize}
        \item $A\cup A^\mathfs{c}=U$
        \item $A\cap A^\mathfs{c}=\emptyset$
\end{itemize}
    \item [(6)] Double Complement Law: For every set $A$,
\end{itemize} \begin{enumerate} \begin{itemize}
        \item $(A^\mathfs{c})^\mathfs{c}=A$
\end{itemize}
    \item [(7)] DeMorgan's Laws: For all sets $A$ and $B$,
\end{itemize} \begin{enumerate} \begin{itemize}
        \item $(A\cup B)^\mathfs{c}=A^\mathfs{c}\cap B^\mathfs{c}$
        \item $(A\cap B)^\mathfs{C}=A^\mathfs{c}\cup B^\mathfs{c}$
\end{itemize}
    \item [(8)] Absorbtion Laws: For all sets $A$ and $B$,
\end{itemize} \begin{enumerate} \begin{itemize}
        \item $A\cup (A\cap B)=A$
        \item $A\cap (A\cup B)=A$
\end{itemize}
    \item [(9)] Set Difference Law: For all sets $A$ and $B$,
\end{enumerate} \begin{enumerate} \begin{itemize}
        \item $A-B=A\cap B^\mathfs{c}$
\end{itemize}
\end{enumerate}
}
